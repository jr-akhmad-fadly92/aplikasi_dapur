                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner text-center">
                                <h5>Supplier</h5>
                                <h3>{{ $supplier }} <i class="fa fa-solid fa-truck"></i></h3>
                            </div>
                            <div class="icon">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 id="table-title"><i class="fas fa-calendar-alt mr-2"></i>Laporan Menu Harian</h4>
                                <div class="card-tools">    
                                    <span id="periode-badge" class="badge badge-info" style="font-size: 12px;">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">
                                        ...
                                        Management Ompreng per Line - {{ date('d F Y') }} {{ $menu->tanggal_kirim ?? 'tidak ada' }}
                                    </h3>
                                    @if(isset($menu) && $menu)
                                    <div class="card-tools">
                                        <span class="badge badge-light">{{ $menu->menu_name ?? 'Menu Hari Ini' }}</span>
                                    </div>
                                    @endif
                                </div>
                                <div class="card-body">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var table1 = $('#table-periode-1').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "/akuntansi/dt_data_bahan_datang",
                    data: function (d) {
                ...
                columns: [
                    ...
                    { data: 'kedatangan', name: 'kedatangan' },
                    { data: 'bahan', name: 'bahan' },
                    { data: 'jumlah_pesanan', name: 'jumlah_pesanan' },
                    { data: 'jumlah_datang', name: 'jumlah_datang' },
                    { data: 'total_kolom', name: 'total_kolom' },
                ],
                responsive: true,
                autoWidth: false,
                language: {
