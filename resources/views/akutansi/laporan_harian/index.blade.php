...
<body class="hold-transition sidebar-mini">
    ...
    $('#btn_tanggal').click(function() {
        ...
        $.ajax({
            url: '{{ url("/laporan_harian/ajax_laporan_harian") }}', // Pastikan URL sudah sesuai
            method: 'POST',
            data: {
                tanggal: tanggal,
        ...
        function downloadLaporanBahanBaku() {
            var tanggal = moment($("#tanggal").val(), 'DD-MM-YYYY').format('YYYY-MM-DD');
            window.location.href = "{{url('/testlaporan')}}?tanggal=" + tanggal;
        }
        function downloadLaporanOPnonBB() {
            var tanggal = moment($("#tanggal").val(), 'DD-MM-YYYY').format('YYYY-MM-DD');
            window.location.href = "{{url('/testlaporan')}}?tanggal=" + tanggal;
        }
        function downloadLaporanGaji() {
            var tanggal = moment($("#tanggal").val(), 'DD-MM-YYYY').format('YYYY-MM-DD');
            window.location.href = "{{url('/testlaporan')}}?tanggal=" + tanggal;
        }
        function downloadLaporanInfra() {
            var tanggal = moment($("#tanggal").val(), 'DD-MM-YYYY').format('YYYY-MM-DD');
            window.location.href = "{{url('/testlaporan')}}?tanggal=" + tanggal;
        }
    </script>
