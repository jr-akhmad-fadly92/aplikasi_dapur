                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-8 col-xs-12">
                                    <h2>Bahan yang harus dikeluarkan hari ini : {{ now()->locale('id')->translatedFormat('l, d F Y') }}</h2>

                                </div>
                                <div class="col-md-4 col-xs-12" style="text-align: right;">
                                    <a href="/warehouse/form_warehouse?type=out" class="btn btn-sm btn-success"><i class="fa fa-plus-circle"></i> barang keluar</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-xs-12" style="text-align: right;">
                                    <div class="form-group">
                                        <a href="/warehouse/form_warehouse?type=in" class="btn btn-sm btn-success"><i class="fa fa-plus-circle"></i> barang masuk</a>
                                        <a href="/warehouse/form_warehouse?type=out" class="btn btn-sm btn-success"><i class="fa fa-plus-circle"></i> barang keluar</a>
                                    </div>
                                </div>
                            </div>
