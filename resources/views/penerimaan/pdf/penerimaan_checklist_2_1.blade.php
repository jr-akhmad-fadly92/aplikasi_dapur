...
<table style="width:100%; border-collapse:collapse; font-family:Arial, Helvetica, sans-serif; font-size:11px;">
    ...
    <tr>
        <td style="text-align:left;" colspan="12">FORMULIR CHECKLIST PENGELUARAN BARANG GUDANG HARIAN</td>
    </tr>
     <tr>
    ...
    <tr style="background-color:#f0f0f0;">
        ...
        <td  style="font-weight:bold;text-align:center;border:1px solid #000;">Jam Masak</td>
        ...
        <td  style="font-weight:bold;text-align:center;border:1px solid #000;">Remark Keluar Gudang</td>
    ...
    @forelse($items as $index => $item)
        <tr style="background-color:#f0f0f0;">
            ...
            <td style="text-align:center;border:1px solid #000;">{{ \Carbon\Carbon::parse($item->jam_pelayanan)->subHours(3)->format('H:i') }}</td>
    ...
    <tr>
        ...
        <td colspan="2">Ahli Akuntansi</td>
