            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body"><h4>Bahan Baku</h4> 
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Andre</td> 
                                            <td>
                                                <button type="button" data-toggle="modal" data-target=".bs-example-modal-center" class="btn btn-primary waves-effect waves-light">
                                            Sampling</button> <!---->
                                            </td>
                                        </tr>
                                    </tbody>
