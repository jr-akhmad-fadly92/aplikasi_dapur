{{-- Generated from database for komponen sehat = 3 (Sayur) --}}
<table style="width:100%; border-collapse:collapse; font-family:Arial, Helvetica, sans-serif; font-size:11px; border: 1px solid #000;">
    ...
    <tr>
        <td style="text-align:center;"></td>
        <td colspan="5" style="text-align:left;">Rekap Sayur Periode Pelayanan SPPG YBBS {{ \Carbon\Carbon::parse($tanggal_awal)->format('j') }} - {{ \Carbon\Carbon::parse($tanggal_akhir)->translatedFormat('j F Y') }}</td>
    </tr>
    <tr>
        <td style="text-align:center;"></td>
