...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Tambah Bahan Masak</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('bahanmasak.store') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="satuan_bahan" id="satuan_bahan" readonly required>
                                        </div>
    ...
    <script>
        document.getElementById('bahan_id').addEventListener('change', function() {
            ...
            let satuanBahan = selectedOption.getAttribute('data-satuan');

            console.log("Bahan dipilih:", selectedOption.text);
            console.log("Satuan bahan:", satuanBahan);

            document.getElementById('satuan_bahan').value = satuanBahan;
        });
    </script>
