...
<div class="container">
    ...
    <div class="section">
        <h3>A. Menu yang diajukan untuk <b>{{ $data_menu_harian->menu }}</b>:</h3>
        <table style="border-collapse: collapse; width: 100%;">
            <tr>
                <td>1. Karbohidrat</td>
                <td>: {{ $karbohidrat->nama_resep }} || A : {{ $rumus_karbo->karbo_porsi_a ?? 0}} gram || B : {{ $rumus_karbo->karbo_porsi_b ?? 0}} gram</td>
            </tr>
            <tr>
                <td>2. Sayur</td>
                <td>: {{ $sayur->nama_resep }} || A : {{ $rumus_sayur->sayur_porsi_a ?? 0}} gram || B : {{ $rumus_sayur->sayur_porsi_b ?? 0}} gram</td>
            </tr>
            <tr>
                <td>3. Protein</td>
                <td>: {{ $protein->nama_resep }} || A : {{ $rumus_protein->protein_porsi_a ?? 0}} gram || B : {{ $rumus_protein->protein_porsi_b ?? 0}} gram</td>
            </tr>
            <tr>
                <td>4. Buah</td>
                <td>: {{ $buah->nama_resep }} || A : {{ $rumus_buah->buah_porsi_a ?? 0}} pcs || B : {{ $rumus_buah->buah_porsi_b ?? 0}} pcs</td>
            </tr>
            <tr>
               
                <td>5. Suplemen</td>
                <td>: {{ $susu->nama_resep }}  || A : {{ $rumus_suplemen->suplemen_porsi_a ?? 0}} pcs / gram || B : {{ $rumus_suplemen->suplemen_porsi_b ?? 0}} pcs / gram</td></td>
            </tr>
        </table>
    </div>
    ...
    <div class="section">
        ...
        @if($karbohidrat->nama_resep == 'kosong')
        @else
