...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-header">
                           ...
                           <div class="form-group mb-2 mr-2">
                            ...
                            <div class="form-group mb-2 mr-2">
                                <a href="{{ route('mastermenu.print-center') }}" id="btn-print-center-page" class="btn btn-dark mb-2">Pusat Cetak</a>
                            </div>
                            </form>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <h3 class="card-title"><a href="{{ route('mastermenu.create') }}" class="edit btn btn-primary btn-sm " id="btn-edit-post">Tambah</a></h3>
                            @endif
    ...
    $(document).ready(function() {
        ...
        $('#cancelForm').submit(function(e) {
            ...
            $.ajax({
                url: '/mastermenu/cancel-confirm/' + id,
                type: 'POST',
                data: $(this).serialize(),
    ...
    <script>
        ...
        $('#confirmAccBtn').click(function () {
            ...
            $.ajax({
                url: '/mastermenu/acc/' + selectedAccId,
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    nama_acc: namaAcc,
    ...
    document.getElementById('btn-print-center-page').addEventListener('click', function(e) {
        e.preventDefault();
        ...
        if (awal) {
            params.set('tanggal', awal);
            params.set('tanggal_awal', awal);
        }

        if (akhir) {
            params.set('tanggal_akhir', akhir);
            if (!params.has('tanggal')) {
                params.set('tanggal', akhir);
            }
        }

        const baseUrl = '{{ route('mastermenu.print-center') }}';
