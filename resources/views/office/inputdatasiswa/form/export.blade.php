...
<div class="container-fluid">
    <div class="card card-danger">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-file-pdf mr-2\1"></i>Export Data Siswa ke PDF
            </h3>
        </div>
        <div class="card-body">
...
<script>
    ...
    $('#form_export_siswa').on('submit', function (e) {
        ...
        xhr.open('POST', '{{ url("inputdatasiswa/exportSiswa") }}', true);
            ...
            if (xhr.status === 200) {
                ...
                if (contentType && contentType.includes('application/json')) {
                    ...
                    if (!filename) {
                        ...
                        filename = 'daftar_siswa_' + timestamp + '.pdf'; // PDF langsung
                    }
    ...
    function previewExportCount() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ url("inputdatasiswa/previewExport") }}',
