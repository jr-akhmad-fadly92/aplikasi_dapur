...
<body class="hold-transition sidebar-mini">
                    ...
                    <form id="formTambah">
                        <div class="modal-body"> 
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="kandungan_create" name="kandungan_create"  style="width: 100%">
                                    @foreach ($kandungan as $data)
                                                 
                                    <option value={{ $data->id }} >{{ $data->kandungan }} </option>
                    ...
                    <form id="formEdit">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="kandungan_update" name="kandungan_update" style="width: 100%">
                                    @foreach ($kandungan as $data)
    ...
    <script>
        $(document).ready(function() {
            $('#kandungan_create').select2({
                placeholder: "Pilih Kandungan",
                allowClear: true
            });
            $('#kandungan_update').select2({
                placeholder: "Pilih Kandungan",
                allowClear: true
            });
    ...
    $(document).ready(function() {
        ...
        $('#formTambah').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: "{{ route('rincian-kandungan-gizi.store') }}",
                type: "POST",
                data: $(this).serialize(),
                 headers: {
        ...
        $(document).on('click', '.btn-edit', function() {
            let id = $(this).data('id');
            $.get("{{ url('rincian-kandungan-gizi') }}/" + id + "/edit", function(data) {
                $('#edit_id').val(data.id);
                $('#kandungan_update').val(data.id_kandungan_gizi).trigger('change'); 
