                    ...
                    <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-right">
                                                    <a class="btn btn-sm btn-success"
                                                        href="/datasekolah/edit/{{$sekolah->id}}"><span
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm"
                                                            ...
                                                            value="@if(isset($sekolah)) {{ $sekolah->id }} @endif"
                                                            disabled>
						...
						<tr>
                                    ...
                                    <div class="card">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-4 text-right">
                                                    <button class="btn btn-sm btn-success"
                                                        onclick="formSiswa({{$sekolah->id}})">Input Data Siswa</button>
                                                    <a class="btn btn-sm btn-info"
                                                        href="/inputdatasiswa?sekolah_id={{$sekolah->id}}">
                                                        <i class="fa fa-users"></i> Kelola Data Siswa
                                                    </a>
                                        ...
                                        <div class="card-body">
                                            <table id="dt_siswa" class="table table-bordered table-striped"
                                        ...
                                        <div class="card-header">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-xs-3" style="text-align: right;">
                                                    <button class="btn btn-sm btn-success"
                                                        onclick="formHariAktif('{{$sekolah->id}}')">Edit</button>
                                                </div>
                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-control-sm" disabled
                                                            id="hari_aktif_senin"
                                                            value="@if (isset($hari_aktif) && $hari_aktif->senin == 1) Masuk @else Libur @endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Selasa</td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-sm" disabled
                                                            id="hari_aktif_selasa"
                                                            value="@if (isset($hari_aktif) && $hari_aktif->selasa == 1) Masuk @else Libur @endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Rabu</td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-sm" disabled
                                                            id="hari_aktif_rabu"
                                                            value="@if (isset($hari_aktif) && $hari_aktif->rabu == 1) Masuk @else Libur @endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Kamis</td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-sm" disabled
                                                            id="hari_aktif_kamis"
                                                            value="@if (isset($hari_aktif) && $hari_aktif->kamis == 1) Masuk @else Libur @endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Jumat</td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-sm" disabled
                                                            id="hari_aktif_jumat"
                                                            value="@if (isset($hari_aktif) && $hari_aktif->jumat == 1) Masuk @else Libur @endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Sabtu</td>
                                                    ...
                                                    <td><input type="text" class="form-control form-control-sm" disabled
                                                            id="hari_aktif_sabtu"
                                                            value="@if (isset($hari_aktif) && $hari_aktif->sabtu == 1) Masuk @else Libur @endif">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Minggu</td>
                                                    <td> : </td>
                                                    <td><input type="text" class="form-control form-control-sm" disabled
                                                            id="hari_aktif_minggu"
                                                            value="@if (isset($hari_aktif) && $hari_aktif->minggu == 1) Masuk @else Libur @endif">
                                                    </td>
                                                </tr>
