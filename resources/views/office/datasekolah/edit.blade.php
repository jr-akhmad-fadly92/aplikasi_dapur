                            ...
                            <form action="{{ route('tingkatansekolah.update', $tingkatansekolah->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="jenjang_sekolah" class="form-control" required>
                                        ...
                                        <option value="Bumil/Busui" {{ old('jenjang_sekolah', $tingkatansekolah->jenjang_sekolah) == 'Bumil/Busui' ? 'selected' : '' }}>Bumil/Busui</option>
                                        <option value="Balita/Baduta" {{ old('jenjang_sekolah', $tingkatansekolah->jenjang_sekolah) == 'Balita/Baduta' ? 'selected' : '' }}>Balita/Baduta</option>
