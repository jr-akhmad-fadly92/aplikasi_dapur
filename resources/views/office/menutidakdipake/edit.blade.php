                        ...
                        <div class="card-body">
                            <form action="{{ route('menu.update', $Menu->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_menu') is-invalid @enderror" name="nama_menu" value="{{ old('nama_menu', $Menu->nama_menu) }}" placeholder="nama_menu">
                                    ...
                                    <label class="font-weight-bold">Komponen Sehat</label>
                                            ...
                                            <select class="form-control" id="id_komponen_sehat" name="id_komponen_sehat">
                                                 ...
                                                 <option value={{ $data->id }}
                                                    @if($data->id == $Menu->id_komponen_sehat)  selected @else  @endif
