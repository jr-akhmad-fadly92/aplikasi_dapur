...
<body class="hold-transition sidebar-mini">
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body">
                            ...
                            <table id="tbl_list_master_kemasan_bahan" class="table table-bordered table-hover" style="width:100%">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Paket</th>
    ...
    $('#tbl_list_master_kemasan_bahan').DataTable({
    ...
    $(document).ready(function() {
        ...
        $('#formTambah').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#tbl_list_master_kemasan_bahan').DataTable().ajax.reload();
                }
            });
        });
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            $.get("{{ url('master-gizi') }}/" + id + "/edit", function(data) {
                $('#edit_id').val(data.id);
                $('#edit_kandungan').val(data.jumlah);
