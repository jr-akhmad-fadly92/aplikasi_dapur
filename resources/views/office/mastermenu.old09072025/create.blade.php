                        ...
                        <div class="card-body">
                            <form id="myForm" action="{{ route('mastermenu.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('menu') is-invalid @enderror" name="menu" id="menu" value="" placeholder="---">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_pengaju') is-invalid @enderror" name="nama_pengaju" id="nama_pengaju">
                               ...
                               <!-- Checkbox untuk menyembunyikan input -->
                                ...
                                <div class="form-group mb-3" id="gramasi_karbo_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_porsi_tray_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_kg_tray_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_lauk_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_sayur_utama_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_sayur_kedua_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_buah_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_suplemen_a_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_karbo_b_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_porsi_tray_b_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_kg_tray_b_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_lauk_b_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_sayur_utama_b_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_sayur_kedua_b_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_buah_b_group">
                                ...
                                <div class="form-group mb-3" id="gramasi_suplemen_b_group">
