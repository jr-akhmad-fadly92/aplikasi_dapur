            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="{{ route('masterresep.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('resep') is-invalid @enderror" name="resep" value="" placeholder="---">
                                ...
                                <button type="submit" class="btn btn-md btn-primary me-3">UPDATssssssssE</button>
