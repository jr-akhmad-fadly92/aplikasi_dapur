                            ...
                            <form id="form_surat_jalan" method="post" action="{{ url('suratJalan/save') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group row">
                                            <label for="driver" class="col-sm-3 col-xs-12 col-form-label">Asisten Petugas pengirim</label>
                                            <div class="col-sm-9 col-xs-12">
                                                <input type="text" class="form-control form-control-sm" id="driver_assistant" name="driver_assistant" placeholder="Nama asisten petugas pengiriman"
                                                @if (isset($surat_jalan))
                                                    value="{{$surat_jalan->driver_assistant}}"
                                                @endif>
                                            </div>
                                        </div>
                                        <!--end form-group-->
