                        ...
                        <div class="card-body">
                            <form action="{{ route('mastermenu.update', $Menu->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <label class="font-weight-bold">Karbohidrat</label>
                                            <select class="form-control" id="karbohidrat" name="karbohidrat">
                                                 ...
                                                 <option value={{ $data->id }}
                                                    @if( $data->id == $Menu->karbohidrat) selected @endif
                                                    >{{ $data->nama_resep }} </option>
                                ...
                                <div class="form-group mb-3">
                                    <label class="font-weight-bold">Protein</label>
                                            <select class="form-control" id="protein" name="protein">
                                                 ...
                                                 <option value={{ $data->id }} 
                                                     @if( $data->id == $Menu->protein) selected @endif
                                                    >{{ $data->nama_resep }} </option>
                                ...
                                <div class="form-group mb-3">
                                    <label class="font-weight-bold">Sayur</label>
                                            <select class="form-control" id="sayur" name="sayur">
                                                 ...
                                                 <option value={{ $data->id }} 
                                                    @if( $data->id == $Menu->sayur) selected @endif
                                                    >{{ $data->nama_resep }} </option>
                                ...
                                <div class="form-group mb-3">
                                    <label class="font-weight-bold">Buah</label>
                                            <select class="form-control" id="buah" name="buah">
                                                 ...
                                                 <option value={{ $data->id }} 
                                                    @if( $data->id == $Menu->buah) selected @endif
                                                    >{{ $data->nama_resep}} </option>
                                ...
                                <div class="form-group mb-3">
                                    <label class="font-weight-bold">Susu</label>
                                            <select class="form-control" id="susu" name="susu">
                                                 ...
                                                 <option value={{ $data->id }} 
                                                    @if( $data->id == $Menu->susu) selected @endif
                                                    >{{ $data->nama_resep }} </option>
                                ...
                                <div class="form-group mb-3">
                                        ...
                                        <input type="date" class="form-control @error('tanggal_pengajuan') is-invalid @enderror" name="tanggal_pengajuan" value="{{ old('tanggal_pengajuan', $Menu->tanggal_pengajuan) }}">
