            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4>Laporan Biaya Bahan Baku</h4><br>
                                <form method="GET" action="{{ route('lbbb.index') }}" >
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 d-flex">
                                        ...
                                        <a href="{{ route('lbbb.cetak2', request()->all()) }}" class="btn btn-primary btn-custom">Cetak Data</a>
                                    </div>
                                    ...
                                    @forelse ($data as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                 @if(!empty($row->tanggal_tutup_po))
                                                {{ date('d-m-Y', strtotime($row->tanggal_tutup_po)) }}
                                            @else
                                                -
                                            @endif<td>{{ $row->deskripsi }}</td>
