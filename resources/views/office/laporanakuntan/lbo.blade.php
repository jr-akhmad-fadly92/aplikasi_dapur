            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4>Laporan Biaya Operasional</h4><br>
                                <form method="GET" action="{{ route('lbo.index') }}" >
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3 d-flex">
                                        ...
                                        <a href="{{ route('lbo.cetak2', request()->all()) }}" class="btn btn-primary btn-custom">Cetak Data </a>
                                    </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-9 col-xs-12">
                                    <h3 class="card-title">Laporan Biaya Operasional</h3>
