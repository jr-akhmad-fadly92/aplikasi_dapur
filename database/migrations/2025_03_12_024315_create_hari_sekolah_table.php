...
class CreateHariSekolahTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hari_sekolah', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('id_tb_data_sekolah');
            $table->boolean('senin')->default(0)->comment('hari aktif senin = 1');
    ...
    {
        Schema::dropIfExists('hari_sekolah');
    }
}
