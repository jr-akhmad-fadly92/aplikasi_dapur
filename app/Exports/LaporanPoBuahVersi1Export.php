...
class LaporanPoBuahVersi1Export implements FromView, ShouldAutoSize, WithStyles
{
    ...
    public function view(): View
    {
       $tanggal_awal = Carbon::parse($this->tanggal_awal)->format('Y-m-d');
        ...
        // Query untuk mendapatkan records dengan filter id_komponen_sehat = 4 (Buah)
        ...
        return view('exports.laporan_po_buah_versi_1', [
            'records' => $records,
            'summary' => $summary,
            'dapur' => $dapur,
