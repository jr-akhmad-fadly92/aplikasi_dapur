...
class LaporanPoPendampingVersi1Export implements FromView, ShouldAutoSize, WithStyles
{
    ...
    public function view(): View
    {
        ...
        // Query untuk mendapatkan records dengan filter id_komponen_sehat = 5 (Pendamping)
        ...
        return view('exports.laporan_po_pendamping_versi_1', [
            'records' => $records,
            'summary' => $summary,
            'dapur' => $dapur,
